...
where s.AddressID=a.AddressID"></asp:SqlDataSource>
    <br />
    <br />
    <asp:Button ID="btnAdd" runat="server" Text="Add" PostBackUrl="SellerAddPage.aspx" Width="100px" Height="40px" />
&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Button ID="btnEdit" runat="server" Text="Edit" PostBackUrl="SellerEditPage.aspx" Width="100px" Height="40px" />
&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Button ID="btnDelete" runat="server" Text="Delete" PostBackUrl="SellerDeletePage.aspx" Width="100px" Height="40px" />
    <br />
</asp:Content>
